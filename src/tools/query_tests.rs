// slugaudit-line-exception: approved-by=slugthug; reason=one test per SQL safety property; splitting would obscure the read-only boundary they collectively pin
use super::*;
