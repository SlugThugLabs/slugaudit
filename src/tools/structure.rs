...
pub fn structure(
    ...
    let limits = resolve_structure_limits(&request.0.path);
    structure_with_limits(request, &limits, sink, manager)
}

fn resolve_structure_limits(path: &str) -> ResourceLimits {
