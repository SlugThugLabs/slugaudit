...
// The parallel batch loop lives in `sample_batch` — it outgrew this
// file's source-size budget once it gained per-file skip handling.
...
pub(super) use super::sample_batch::sample_all_with_deadline;
